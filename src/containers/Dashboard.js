...
export default class {
  ...
  handleClickIconEye = () => {
    ...
    // remplacement de null par un texte informatif
    if (!billUrl || billUrl === "null" || billUrl === "undefined") {
      $("#modaleFileAdmin1")
        .find(".modal-body")
        .html(
          `<div style='text-align: center;'><p>Aucun justificatif disponible</p></div>`
        );
    } else {
      // on affiche l'image
      $("#modaleFileAdmin1")
